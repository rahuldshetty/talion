...
type (
	prefixParseFn func() ast.Expression // fn type called for token in prefix pos
	infixParseFn func(ast.Expression) ast.Expression // fn type called for token in infix pos
)
...
// parses x,y,z item expression start and ending with "end" token opposites
